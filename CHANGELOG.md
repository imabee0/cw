...
- *(ci)* stop GitHub running github-build-setup as a workflow ([#30](https://github.com/imabee0/cw/pull/30))
...
- *(tui)* clickable agents, safer delete, and clone error modal ([#26](https://github.com/imabee0/cw/pull/26))
